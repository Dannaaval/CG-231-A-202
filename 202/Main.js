...
//Aplicar transformaciones a la piramide
piramide[1].applyMatrix(Traslacion([2*lado,2*lado,0]));
piramide[1]=Escalado(piramide[1],[1.5,1.5,1.5],[2*lado,2*lado,0]);
piramide[1]=rotarRealX(piramide[1],45,[2*lado,2*lado,0]);
piramide[1]=rotarRealY(piramide[1],45,[2*lado,2*lado,0]);
piramide[1]=rotarRealZ(piramide[1],60,[2*lado,2*lado,0]);
